          ...
          >
            ...
            <SwiperSlide className="portfolio_content grid ">
              ...
              <div className="portfolio_data">
                ...
                <p className="portfolio_description">
                  Complete responsive dynamic single page website, Crypto Coin
                  shows real time current information about the crypto coins.
                </p>

                <a
                  href="https://cryptocoin-3z6dhqi11-komal-bhurse.vercel.app"
                  target="_blank"
                  rel="noreferrer"
            ...
            <SwiperSlide className="portfolio_content grid">
              ...
              <div className="portfolio_data">
                ...
                <p className="portfolio_description">
                  Cakeat is an E-commerce Websites adaptable to all devices,
                  with attractive ui components .
                </p>

                <a
                  href="https://cakeat.onrender.com"
                  target="_blank"
                  rel="noreferrer"
                  className="button button--flex button--small portfolio_button"
                >
